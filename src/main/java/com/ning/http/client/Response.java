...
public interface Response {
     ...
     * @param maxLength The maximum number of bytes to read
     * @param charset   the charset to use when decoding the stream
     * @param overrideHeader - if true, charset used regardless of charset in content-type header.
     *                          if false, charset only used if content-type header doesn't contain a valid charset
     * @return The response body
     * @throws java.io.IOException
     */
