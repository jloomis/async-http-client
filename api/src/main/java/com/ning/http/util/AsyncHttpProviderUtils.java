...
public class AsyncHttpProviderUtils {
    ...
    public final static String contentToString(List<HttpResponseBodyPart> bodyParts, String charset, int maxLength) throws UnsupportedEncodingException {
        return new String(contentToBytes(bodyParts, maxLength), charset);
    }
